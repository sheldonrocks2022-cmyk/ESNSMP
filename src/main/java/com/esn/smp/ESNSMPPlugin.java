...
public final class ESNSMPPlugin extends JavaPlugin {
    ...
    @Override public void onEnable() {
        ...
        AdminControlCenter adminCenter=new AdminControlCenter(this,gameplay,v18Core);registerCommand("admin",adminCenter);getServer().getPluginManager().registerEvents(adminCenter,this);
